...
public class Main {
    public static void main(String[] args) {
        ...
        Car lada = new Car("Lada",
                ...
                "желтого",
                2015, "в России",
                (new Car.Key(false,false)), (new Car.Insurance(LocalDate.now(), 12520,"12358")));
        ...
        Car audi = new Car("Audi", "A8 50 L TDI quattro",
                3.0f, "черного", 2020, "в Германии",
                (new Car.Key(true,true)),
                (new Car.Insurance(LocalDate.of(2020,12,5), 52000,"123456789")));
        ...
        Car bmw = new Car("BMW", "Z8",
                3.0f, "черного", 2021,
                "в Германии", (new Car.Key()),
                (new Car.Insurance(LocalDate.now(), 85236, "8563214598l")));
        ...
        Car kia = new Car("Kia", "Sportage 4-го поколения",
                ...
                (new Car.Insurance(LocalDate.of(2021,28,25), 89654, "lfkmfkfk4152")));
        kia.setTransmisson("auto");
        kia.setBodyType("suv");
        kia.setSummerTires(true);
        kia.setRegistrNumber("d898ee856");
        kia.setNumberOfSeats(5);
        Car hyundai = new Car("Hyundai", "Solaris", -5, null,
                2016, "в Южной Корее",
