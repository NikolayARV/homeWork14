...
public class TestTransport {
    public static void main(String[] args) {
        ...
        Truck truck3 = new Truck("Маз", "555", null,10);
        Truck truck4 = new Truck("Газон", "53", LoadCapacity.N1, 6);
        Bus bus1 = new Bus("ПАЗ", "1", Capacity.L,5);
        Bus bus2 = new Bus("Газель-Бизнес", "1", Capacity.S,9);
        Bus bus3 = new Bus("Маз", "3", Capacity.L,6);
        Bus bus4 = new Bus("Лиаз", "4", Capacity.M,8);
        Car car1 = new Car("ЗАЗ", "968", BodyType.VNEDOROGNIK,  0.7f);
        Car car2 = new Car("УАЗ", "456", BodyType.VNEDOROGNIK, 2.2f);
        Car car3 = new Car("ВАЗ", "01", BodyType.CUPE, 1.2f);
        Car car4 = new Car("ГАЗ", "21", BodyType.UNIVERSAL, 2.4f);
        ...
        System.out.println(LoadCapacity.N3);
        System.out.println(Capacity.XL);
